import NonfungibleTokenPositionDescriptor from '../artifacts/contracts/v3-periphery/NonfungibleTokenPositionDescriptor.sol/NonfungibleTokenPositionDescriptor.json'
